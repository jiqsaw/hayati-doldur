<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="Activities.aspx.cs" Inherits="Activities" %>
<%@ Register src="~/UC/Activities/uActivities.ascx" tagname="uActivities" tagprefix="uc1" %>
...
<uc1:uActivities ID="uActivities1" runat="server" />
