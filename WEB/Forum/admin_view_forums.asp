...
Else
  ...
  <table border="0" align="center" cellpadding="2" cellspacing="1" class="tableBorder">
    ...
    <tr>
      <td colspan="3" class="tableSubLedger"><a href="admin_category_details.asp?CatID=<% = intCatID & strQsSID2 %>"><b><% = strCategory %></b></a></td>
    ...
    <%
		...
		Else
			...
			Do While NOT intCurrentRecord > Ubound(sarryForums,2)
				...
				%>
    <tr>
      <td class="tableRow"><a href="admin_forum_details.asp?FID=<% = intForumID %><% = strQsSID2 %>"><% = strForumName %></a> <br />
    ...
    <%					
				...
				%>
    <tr>
      <td class="tableRow">&nbsp;&nbsp;<img src="<% = strImagePath %>arrow.gif" />&nbsp;<a href="admin_forum_details.asp?sub=true&amp;FID=<% = intSubForumID %><% = strQsSID2 %>"><% = strForumName %></a> <br />
        &nbsp;&nbsp;&nbsp;&nbsp;<span class="smText"><% = strForumDiscription %></span></td>
    ...
    <td colspan="2" align="center" class="text">Use the buttons below to create new, Categories, Forums, or Sub Forums <br />
      <table width="100%" border="0" cellspacing="0" cellpadding="1" align="center">
        <tr align="center">
          ...
          <td><form action="admin_forum_details.asp?sub=true<% = strQsSID2 %>" method="post" name="form3" id="form3">
