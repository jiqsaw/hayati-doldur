...
If blnLCode = True Then
	Response.Write("<span class=""text"" style=""font-size:10px"">Bulletin Board Software by Web Wiz Forums&reg; version " & strVersion& " - http://www.webwizforums.com</span>")
	Response.Write("<br /><span class=""text"" style=""font-size:10px"">Copyright &copy;2001-2010 Web Wiz - http://www.webwizguide.com</span>")
End If 
'***** END WARNING - REMOVAL OR MODIFICATION OF THIS CODE WILL VIOLATE THE LICENSE AGREEMENT ******
