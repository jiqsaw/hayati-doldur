...
%>
    ...
    <script language="javascript" type="text/javascript">
       ...
       document.write ('<iframe id="WebWizRTE" src="RTE_textarea.asp?mode=<% = strMode %>&POID=<% = lngMessageID %>&ID=<% = CInt(RND * 2000) & strQsSID2 %>" width="650" height="300" style="border: #A5ACB2 1px solid" onLoad="initialiseWebWizRTE();" tabindex="20"></iframe>');
    </script>
