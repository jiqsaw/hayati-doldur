...
'insert toolbar
'------------
If blnAdvAdddHyperlink OR blnAddHyperlink Or blnAttachments OR blnAdvAddImage OR blnAddImage OR blnFlashFiles OR blnInsertTable OR blnSpecialCharacters Or blnEmoticons Then Response.Write(vbCrLf & "	document.writeln('<img src=""" & strImagePath & "toolbar_separator.gif"" />")
...
If blnFlashFiles Then Response.Write("   <img src=""" & strImagePath & "post_button_movie.gif"" onclick=""winOpener(\'RTE_popup_movie.asp" & strQsSID1 & "\',\'movie\',0,1,740,505)"" title=""" & strTxtInsertMovie & """ border=""0"" class=""WebWizRTEbutton"" onmouseover=""overIcon(this)"" onmouseout=""outIcon(this)"" />")
...
If blnAdvAdddHyperlink OR blnAddHyperlink Or blnAttachments OR blnAdvAddImage OR blnAddImage OR blnFlashFiles OR blnInsertTable OR blnSpecialCharacters Or blnEmoticons Then Response.Write("');")
...
If blnLCode Then
	...
	Response.Write("<img src=""" & strImagePath & "post_button_about.gif"" onclick=""winOpener(\'RTE_popup_about.asp" & strQsSID1 & "\',\'about\',0,0,415,177)"" title=""" & strTxtAboutRichTextEditor & """ class=""WebWizRTEbutton"" onmouseover=""overIcon(this)"" onmouseout=""outIcon(this)"" />")
	Response.Write("');")
End If
%>