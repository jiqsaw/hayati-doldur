	...
	If blnEmail Then
		...
		Do While NOT rsCommon.EOF
			...
			If lngEmailUserID <> lngPostersID AND lngEmailUserID <> lngLoggedInUserID AND Trim(strUserEmail) <> "" Then
				...
				Call SendMail(strEmailMessage, decodeString(strUserName), decodeString(strUserEmail),	strMainForumName, decodeString(strForumEmailAddress), decodeString(strEmailSubject), strMailComponent, true)
			End If
