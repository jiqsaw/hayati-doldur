...
'If there are no topics to display on the page and the paghe number is hihger than 1 go to page one
'ElseIf rsCommon.EOF AND intRecordPositionPageNum > 1 Then
	...
	'Redirect
	'Response.Redirect("active_topics.asp" & strQsSID1)
		...
		"</div>")
		 ...
		 If intNumberOfTopicPages > 1 Then
		 	...
		 	For intTopicPagesLoopCounter = 1 To intNumberOfTopicPages
		 		...
		 		Response.Write("<a href=""forum_posts.asp?TID=" & lngTopicID & "&PN=" & intTopicPagesLoopCounter & strQsSID2)
