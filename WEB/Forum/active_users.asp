...
If blnAdmin OR blnModerator Then Response.Write(vbCrLf & "  <td width=""10%"" align=""left"">" & strTxtIP & "</td>")
%>
...
%>
 <tr class="<% If (intForumColourNumber MOD 2 = 0 ) Then Response.Write("evenTableRow") Else Response.Write("oddTableRow") %>"> 
  <td><% 
        ...
        %></td>
  <td nowrap><% Response.Write(DateFormat(dtmLastActive) & " " & strTxtAt & "&nbsp;" & TimeFormat(dtmLastActive))  %></td>
