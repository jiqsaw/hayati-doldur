...
If strUserInput <> "" AND  blnCAPTCHAsecurityImages Then			
...
If blnInvalidUsername OR blnInvalidEmail OR (blnSecurityCodeOK = False AND blnCAPTCHAsecurityImages) OR (blnEmailSent = False AND strEmailErrorMessage <> "") Then
%>
...
If blnCAPTCHAsecurityImages Then
