  ...
  <table align="center" cellpadding="4" cellspacing="1" class="tableBorder" style="width:380px">
    ...
    <tr>
      <td class="tableRow">Username
        ...
        <a href="javascript:winOpener('pop_up_member_search.asp<% = strQsSID1 %>','memSearch',0,1,440,255)"><img src="<% = strImagePath %>member_search.png" title="Member Search" border="0" align="absbottom" /></a>
