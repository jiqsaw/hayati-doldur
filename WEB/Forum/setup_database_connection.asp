...
If Request.Form("postBack") AND strErrorMessage = "" Then 	
	...
	If Request.Form("DbType") = "SQLServer" OR Request.Form("DbType") = "SQLServer2000" Then
		...
		VbCrLf & "strDatabaseType = ""SQLServer""	'Microsoft SQL Server 2000, 2005, 2008 (Supports Enterprise, Standard, Workgroup, Web, and Express Editions)" & _
		VbCrLf & "'strDatabaseType = ""mySQL""	'MySQL 4.1 or MySQL 5" & _
	...
	Else
		...
		Else
			Response.Redirect("setup_db.asp?setup=9Update")	
...
%>
    ...
    <tr>
      <td colspan="2" align="left"  class="tableSubLedger"><strong >Advanced Options</strong></td>
    </tr>
    <%
