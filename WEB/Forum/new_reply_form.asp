...
If isNumeric(Request.QueryString("TR")) Then lngTotalRecords = CLng(Request.QueryString("TR")) Else lngTotalRecords = 1
intForumID = 0
...
'If this is a submission from the quick reply form to the full reply form run so extra code
