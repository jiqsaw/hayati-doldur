...
If Request.Form("postBack") Then
	...
	blnEmailSent = SendMail(strEmailBody, strToUser, decodeString(strToEmail), strMainForumName, decodeString(strForumEmailAddress), strSubject, strMailComponent, false)

	'If the user wants a copy of the email as well send em one
	If Request.Form("mySelf") Then
		Call SendMail(strEmailBody, strLoggedInUsername, decodeString(strFromEmail), strMainForumName, decodeString(strForumEmailAddress), strSubject, strMailComponent, false)
	End If
