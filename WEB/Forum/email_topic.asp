...
If NOT Request.Form("ToName") = "" AND NOT Request.Form("ToEmail") = "" AND NOT Request.Form("FromName") = "" AND NOT Request.Form("message") = "" Then
	...
	blnSentEmail = SendMail(strEmailBody, strRecipientName, decodeString(strRecipientEmail), strMainForumName, decodeString(strForumEmailAddress), strSubject, strMailComponent, false)
End If
