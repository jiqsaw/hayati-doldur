...
<table width="98%" height="14" border="0" align="center" cellpadding="3" cellspacing="1" class="tableBorder">
  ...
  <tr >
    ...
    <td width="50%" class="tableRow"><input name="name1" type="text" size="15" maxlength="20" value="<% = strUsername %>"<% If strMode ="edit" AND (blnMemberAPI OR blnDemoMode) Then Response.Write(" readonly=""readonly""") %> /></td>
  </tr>
  <tr>
