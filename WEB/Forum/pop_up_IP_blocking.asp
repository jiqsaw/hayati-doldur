...
Else
	...
	strSQL = "SELECT " & strDbTable & "BanList.Ban_ID, " & strDbTable & "BanList.IP " & _
...
<table cellspacing="1" cellpadding="3" class="tableBorder" align="center" style="width: 350px;">
 <tr class="tableLedger">
  <td colspan="2"><% = strTxtBlockedIPList %></td>
 </tr>
 <tr class="tableRow"><%
...
<table cellspacing="1" cellpadding="3" class="tableBorder" align="center" style="width: 350px;">
 ...
 <tr class="tableRow">
  <td align="right"><% = strTxtIpAddressRange %>:</td>
  <td><input type="text" name="IP" id="IP" size="20" maxlength="30" value="<% = Server.HTMLEncode(Request.QueryString("IP")) %>" /></td>
 </tr>
