...
%></td>
   ...
   <tr class="tableRow">
    ...
    <td valign="top"><input type="password" name="password1" id="password1" size="15" maxlength="15" value="" autocomplete="off" tabindex="2"<% If strMode ="update" AND blnDemoMode Then Response.Write(" disabled=""disabled""") %> /></td>
   </tr>
   <tr class="tableRow">
    <td><% If strMode = "new" Then Response.Write(strTxtRetypePassword & "*") Else Response.Write(strTxtRetypeNewPassword) %></td>
    <td><input type="password" name="password2" id="password2" size="15" maxlength="15" value="" autocomplete="off" tabindex="3"<% If strMode ="update" AND blnDemoMode Then Response.Write(" disabled=""disabled""") %> /></td>
   </tr><%
...
%>
   <tr class="tableRow">
    ...
    <td><input type="password" name="oldPass" id="oldPass" size="15" maxlength="15" value="" autocomplete="off" tabindex="4"<% If blnDemoMode Then Response.Write(" disabled=""disabled""") %> /></td>
   </tr><%
...
If intUpdatePartNumber = 0 OR intUpdatePartNumber = 2 Then
   ...
   <tr class="tableRow">
    <td width="50%"><% = strTxtRealName %></td>
    <td width="50%"><input type="text" name="realName" id="realName" size="30" maxlength="27" value="<% = strRealName %>" tabindex="9" /></td>
   </tr>
   <tr class="tableRow">
   ...
   <tr class="tableRow">
    ...
    <td>
     <input type="text" name="location" id="location" size="15" maxlength="15" value="<% = strLocation %>" tabindex="11" />
    </td>
   </tr><%
...
%>
   <tr class="tableRow">
    ...
    <td width="50%"><input type="text" name="homepage" size="30" maxlength="48" value="<% If strHomepage = "" Then Response.Write "http://" Else Response.Write(strHomepage) %>" tabindex="12" /></td>
   </tr>
   <tr class="tableRow">
    <td><% = strTxtICQNumber %></td>
    <td><input type="text" name="ICQ" id="ICQ" size="15" maxlength="15" value="<% = strICQNum %>" tabindex="13" /></td>
   </tr>
   <tr class="tableRow">
    <td><% = strTxtAIMAddress %></td>
    <td><input type="text" name="AIM" id="AIM" size="30" maxlength="60" value="<% = strAIMAddress %>" tabindex="14" /></td>
   </tr>
   <tr class="tableRow">
    <td><% = strTxtMSNMessenger %></td>
    <td><input type="text" name="MSN" id="MSN" size="30" maxlength="60" value="<% = strMSNAddress %>" tabindex="15" /></td>
   </tr>
   <tr class="tableRow">
    <td><% = strTxtYahooMessenger %></td>
    <td><input type="text" name="Yahoo" id="Yahoo" size="30" maxlength="60" value="<% = strYahooAddress %>" tabindex="16" /></td>
   </tr>
   <tr class="tableRow">
    <td><% = strTxtSkypeName %></td>
    <td><input type="text" name="skype" id="skype" size="30" maxlength="30" value="<% = strSkypeName %>" tabindex="17" /></td>
   </tr>
   <tr class="tableRow">
    <td><% = strTxtOccupation %></td>
    <td><input type="text" name="occupation" id="occupation" size="30" maxlength="40" value="<% = strOccupation %>" tabindex="18" /></td>
   </tr>
   <tr class="tableRow">
    <td><% = strTxtInterests %></td>
    <td><input type="text" name="interests" id="interests" size="30" maxlength="130" value="<% = strInterests %>" tabindex="19" /></td>
   </tr>
   <tr class="tableRow">
    <td><% = strTxtDateOfBirth %></td>
    <td><% = strTxtDay %>
     <select name="DOBday" id="DOBday" tabindex="20">
...
%>
    ...
    <% = strTxtCMonth %>
    <select name="DOBmonth" id="DOBmonth" tabindex="21">
...
%>
     ...
     <% = strTxtCYear %>
     <select name="DOByear" id="DOByear" tabindex="22">
...
%>
   <tr class="tableRow">
    ...
    <table width="290" border="0" cellspacing="0" cellpadding="1">
     <tr>
      <td width="168">
       <select name="SelectAvatar" id="SelectAvatar" size="4" onchange="(avatar.src = SelectAvatar.options[SelectAvatar.selectedIndex].value) && (txtAvatar.value='http://') && (oldAvatar.value='')" tabindex="23">
      ...
      <tr>
       <td width="168"><input type="text" name="txtAvatar" id="txtAvatar" size="30" maxlength="95" value="<%
		...
		Else
			Response.Write("http://")
		End If
        %>" onchange="oldAvatar.value=''" tabindex="24" /></td>
      <td width="122"><input type="button" name="preview" id="preview" value="<% = strTxtPreview %>" onclick="avatar.src=txtAvatar.value" tabindex="25" /></td>
     </tr>
    </table><%
...
%>
   <tr class="tableRow">
    <td valign="top"><% = strTxtSignature %><br /><span class="smText"><% = strTxtSignatureLong %>&nbsp;(max 200 characters)
     ...
     <br />
     <br />
     <a href="javascript:winOpener('BBcodes.asp<% = strQsSID1 %>','codes',1,1,610,500)" class="smLink"><% = strTxtForumCodes %></a> <% = strTxtForumCodesInSignature %></span></td>
    <td valign="top" height="2">
     <textarea name="signature" id="signature" cols="30" rows="3" onKeyDown="characterCounter('sigChars', 'signature');" onKeyUp="characterCounter('sigChars', 'signature');" tabindex="26"><% = strSignature %></textarea>
     <br />
     <input size="3" value="0" name="sigChars" id="sigChars" maxlength="3" />
     <input onclick="characterCounter('sigChars', 'signature');" type="button" value="<% = strTxtCharacterCount %>" name="Count" />&nbsp;&nbsp;<span class="smText"><a href="javascript:OpenPreviewWindow('signature_preview.asp<% = strQsSID1 %>')" class="smLink"><% = strTxtSignaturePreview %></a>
    </td>
   </tr>
   <tr class="tableRow">
    <td><% = strTxtAlwaysAttachMySignature %></td>
    <td><% = strTxtYes %><input type="radio" name="attachSig" value="true" <% If blnAttachSignature = True Then Response.Write "checked" %> tabindex="27" />&nbsp;&nbsp;<% = strTxtNo %><input type="radio" name="attachSig" value="false" <% If blnAttachSignature = False Then Response.Write "checked" %> tabindex="28" /></td>
   </tr><%
...
If intUpdatePartNumber = 0 OR intUpdatePartNumber = 3 Then
   ...
   <tr class="tableRow">
    ...
    <td width="50%" valign="top"><% = strTxtYes %><input type="radio" name="newsletter" id="newsletter" value="True" <% If blnNewsletter = True Then Response.Write "checked" %> tabindex="6" />&nbsp;&nbsp;<% = strTxtNo %><input type="radio" name="newsletter" id="newsletter" value="False" <% If blnNewsletter = False Then Response.Write "checked" %> tabindex="7" /></td>
   </tr><%
       		 End If
...
%>
   <tr class="tableRow">
    ...
    <td width="50%" valign="top"><% = strTxtYes %><input type="radio" name="emailShow" id="emailShow" value="True" <% If blnShowEmail = True Then Response.Write "checked" %> tabindex="29" />&nbsp;&nbsp;<% = strTxtNo %><input type="radio" name="emailShow" id="emailShow" value="False" <% If blnShowEmail = False Then Response.Write "checked" %> tabindex="30" />
   </td>
   </tr><%
   ...
   <tr class="tableRow">
    ...
    <td width="50%" valign="top"><% = strTxtYes %><input type="radio" name="replyNotify" id="replyNotify" value="True" <% If blnReplyNotify = True Then Response.Write "checked" %> tabindex="31" />&nbsp;&nbsp;<% = strTxtNo %><input type="radio" name="replyNotify" id="replyNotify" value="False" <% If blnReplyNotify = False Then Response.Write "checked" %> tabindex="32" /></td>
   </tr><%
   ...
   <tr class="tableRow">
    ...
    <td width="50%" valign="top"><% = strTxtYes %><input type="radio" name="pmNotify" id="pmNotify" value="True" <% If blnPMNotify = True Then Response.Write "checked" %> tabindex="33" />&nbsp;&nbsp;<% = strTxtNo %><input type="radio" name="pmNotify" id="pmNotify" value="False" <% If blnPMNotify = False Then Response.Write "checked" %> tabindex="34" /></td>
   </tr><%
        	End If
	End If
...
%>
   <tr class="tableRow">
    ...
    <td width="50%" valign="top"><% = strTxtYes %><input type="radio" name="ieEditor" id="ieEditor" value="True" <% If blnWYSIWYGEditor = True Then Response.Write "checked" %> tabindex="35" />&nbsp;&nbsp;<% = strTxtNo %><input type="radio" name="ieEditor" id="ieEditor" value="False" <% If blnWYSIWYGEditor = False Then Response.Write "checked" %> tabindex="36" /></td>
   </tr><%
	End If
   ...
   <tr class="tableRow">
    ...
    <td width="50%" valign="top"><% = strTxtYes %><input type="radio" name="Login" id="Login" value="True" <% If blnAutoLogin = True Then Response.Write "checked" %> tabindex="37" />&nbsp;&nbsp;<% = strTxtNo %><input type="radio" name="Login" id="Login" value="False" <% If blnAutoLogin = False Then Response.Write "checked" %> tabindex="38" /></td>
   </tr>
   <tr class="tableRow">
...
%></span></td>
    <td valign="top">
     <select name="serverOffSet" id="serverOffSet" tabindex="39">
      <option value="+" <% If strTimeOffSet = "+" Then Response.Write("selected") %>>+</option>
      <option value="-" <% If strTimeOffSet = "-" Then Response.Write("selected") %>>-</option>
     </select>
    <select name="serverOffSetHours" tabindex="40"><%
...
%>
   ...
   <td><% = strTxtDateFormat %></td>
    <td valign="top">
     <select name="dateFormat" tabindex="41">
      <option value="dd/mm/yy" <% If saryDateTimeData(0,0) = "dd/mm/yy" Then Response.Write("selected") %>><% = strTxtDayMonthYear %></option>
      <option value="mm/dd/yy" <% If saryDateTimeData(0,0) = "mm/dd/yy" Then Response.Write("selected") %>><% = strTxtMonthDayYear %></option>
      <option value="yy/mm/dd" <% If saryDateTimeData(0,0) = "yy/mm/dd" Then Response.Write("selected") %>><% = strTxtYearMonthDay %></option>
      <option value="yy/dd/mm" <% If saryDateTimeData(0,0) = "yy/dd/mm" Then Response.Write("selected") %>><% = strTxtYearDayMonth %></option>
     </select>
    </td>
   </tr><%
...
If blnAdminMode AND (blnAdmin Or blnModerator) Then
   ...
   <tr class="tableRow">
    ...
    <td width="50%"><% = strTxtYes %><input type="radio" name="active" id="active" value="True" <% If blnUserActive = True Then Response.Write "checked" %> tabindex="42"<% If blnDemoMode Then Response.Write(" disabled=""disabled""") %> />&nbsp;&nbsp;<% = strTxtNo %><input type="radio" name="active" id="active" value="False" <% If blnUserActive = False Then Response.Write "checked" %> tabindex="43"<% If blnDemoMode Then Response.Write(" disabled=""disabled""") %> /></td>
   </tr>
   <tr class="tableRow">
    <td width="50%"><% = strTxtSuspendUser %></td>
    <td width="50%"><% = strTxtYes %><input type="radio" name="banned" id="banned" value="True" <% If blnSuspended = True Then Response.Write "checked" %> tabindex="44"<% If blnDemoMode Then Response.Write(" disabled=""disabled""") %> />&nbsp;&nbsp;<% = strTxtNo %><input type="radio" name="banned" id="banned" value="False" <% If blnSuspended = False Then Response.Write "checked" %> tabindex="45"<% If blnDemoMode Then Response.Write(" disabled=""disabled""") %> /></td>
   </tr><%
   ...
   <tr class="tableRow">
    <td><% = strTxtGroup %></td>
    <td>
     <select name="group" id="group" tabindex="46"<% If blnDemoMode Then Response.Write(" disabled=""disabled""") %>><%
	                        ...
	                        Do While NOT rsCommon.EOF
	                                ...
	                                If blnSelSpecialGroup Then
	                                        Response.Write(">" & strSelGroupName & " - " & strTxtNonRankGroup & "</option>" & vbCrLf)
	                                Else
	                                        Response.Write(">" & strSelGroupName & " - " & strTxtRankGroupMinPosts & " " & lngSelMinimumRankPosts & "</option>" & vbCrLf)
	                                End If
...
%>
   ...
   <tr class="tableRow">
    ...
    <td ><input type="text" name="memTitle" id="memTitle" size="30" maxlength="40" value="<% = strMemberTitle %>" tabindex="47"<% If blnDemoMode Then Response.Write(" disabled=""disabled""") %> /></td>
   </tr>
   <tr class="tableRow">
    <td><% = strTxtNumberOfPosts %></td>
    <td><input type="text" name="posts" id="posts" size="4" maxlength="7" value="<% = lngPosts %>" tabindex="48"<% If blnDemoMode Then Response.Write(" disabled=""disabled""") %> /></td>
   </tr>
   <tr class="tableRow">
    <td valign="top"><% = strTxtAdminNotes %><br /><psan class="smText"><% = strTxtAdminNotesAbout %>.</span></td>
    <td><textarea name="notes" id="notes" cols="30" rows="4" onKeyDown="characterCounter('notesChars', 'notes');" onKeyUp="characterCounter('notesChars', 'notes');" tabindex="49"<% If blnDemoMode Then Response.Write(" disabled=""disabled""") %>><% = strAdminNotes %></textarea>
    	<br />
