...
function CheckForm () {
	...
	if (document.frmImport.nameField.value==""){
   ...
   <form action="admin_import_members.asp" method="post" name="frmImport" id="frmImport" onsubmit="return CheckForm();">
    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="tableBorder">
     ...
     <tr class="text">
      ...
      <td valign="top" class="tableRow" ><input name="nameField" type="text" id="nameField" size="20" maxlength="50"<% If blnDemoMode Then Response.Write(" disabled=""disabled""") %> /></td>
     </tr>
     <tr class="text">
