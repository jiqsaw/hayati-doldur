...
If blnLoggedInUserEmail AND blnEmail AND NOT rsCommon.EOF Then 
	...
	blnEmailSent = SendMail(strEmailBody, decodeString(strLoggedInUsername), decodeString(strLoggedInUserEmail), strMainForumName, decodeString(strForumEmailAddress), decodeString(strPmSubject), strMailComponent, true)
End If
