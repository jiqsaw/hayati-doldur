<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="PhotoDetail.aspx.cs" Inherits="PhotoDetail" %>
<%@ Register src="~/UC/Photo/uPhotoDetail.ascx" tagname="uPhotoDetail" tagprefix="uc1" %>
...
<uc1:uPhotoDetail ID="uPhotoDetail1" runat="server" />
